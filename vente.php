...
secondary">Annuler</button>
        ...
        <button type="button" class="btn btn-info" onclick="window.print()">Imprimer</button>
        <form action="vente.php" method="post" class="d-inline">

            <button type="submit" name="new" class="btn btn-warning">Nouvelle vente</button>
